		...
		<div class="row">
			...
			<div class="col-xs-7">
				...
				<ul>
					...
					<li>Для уже опытных разработчиков, которые хотят поучаствовать в программе в любой роли - мы никогда
						не откажемся от инициативы и помощи!
					</li>
				</ul>
				...
				<ul>
					<li>
						...
						<ul>
							...
							<li>Не бюрократизирована - не заключаем договоров, не подписываемся под обязательствами;
							</li>
			...
			<div class="col-xs-7">
				...
				<ul>
					...
					<li>
						...
						<ul>
							...
							<li>Участие в разработке открытых проектов само по себе плюс для портфолио и будущей
								карьеры;
							</li>
				...
				<ul>
					<li>
						...
						<ul>
							...
							<li>Принять взаимное решение &laquo;работаем дальше&raquo; или &laquo;не интересно&raquo;.
							</li>
				...
				<ul>
					<li>
						...
						<ul>
							<li>Раз в неделю, как договоримся, мы собираемся у нас в офисе и обсуждаем вопросы, которые
								вы сами хотите обсудить;
							</li>
							<li>Проводим мастер-классы на самые острые темы;</li>
							<li>Разбираем основательно и подробно сложные кейсы по задачам, которыми вы занимаетесь.
							</li>
							<li>Если вы удаленщик, пока еще ничего не предусмотрено... и вам будет сложнее. Но трудности
								только закаляют, м? :-)
							</li>
							<li>На крайний случай, есть общий skype-чат для всех участников, в котором можно задавать
								даже самые глупые вопросы.
							</li>
						</ul>
					</li>
				</ul>
				...
				<ul>
					<li>
						...
						<ul>
							...
							<li>При обнаружении взаимного восторга от сотрудничества, вы получаете отличные
								рекомендации, а возможно – и хорошо оплачиваемое место работы.
							</li>
						</ul>
					</li>
				</ul>
