...
<table id="rates" class="table rates" style="margin-left: -118px;">
	...
	<tr>
		<td>% годовых</td>
		<td>От 1095% до 1181,9%</td>
		<td>От 41,71% до 146%</td>
		<td>От 78,21% до 273,75%</td>
	</tr>
	<tr>
		<td>Стоимость</td>
		<td>До 6800 р.</td>
...
<div class="info-summary" style="text-align: center; margin-bottom: 40px;">
	...
	<h5>Получай деньги на 30 дней, когда они тебе действительно нужны.</h5>
		...
		<div class="accordion" id="accordion-rate-minimum">
			...
			<div class="accordion-group">
				...
				<div id="c15" class="accordion-body collapse">
					<div class="accordion-inner">
						<p>Не чаще раза в сутки, не более 5 переводов в месяц.</p>
				...
				<div id="c16" class="accordion-body collapse">
					<div class="accordion-inner">
						<ul>
							...
							<li>Служба поддержки 24/7 (SMS и E-mail информирование, Контактный центр 8(499)704-31-72)
							</li>
						</ul>
					</div>
				</div>
					...
					<div class="accordion-inner">
						...
						<ol>
							<li>Отправь запрос через личный кабинет на сайте kreddy.ru или SMS-запрос на 7570.
								Подробности <a href="/pages/view/smsinfopost">здесь</a>.
							</li>
					...
					<div class="accordion-inner">
						<ol>
							<li>Выбери тариф &laquo;ВСЁ ВКЛЮЧЕНО&raquo; с опцией &laquo;Оплатить абонентку
								сразу&raquo;</li>
							<li>Получи одобрение на повторное подключение сервиса и на доступный размер перевода.</li>
