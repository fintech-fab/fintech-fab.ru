			...
			<div class="col-sm-8 col-sm-offset-2 mb3_firstrow">
				<div class="row">
					<div class="col-xs-3 mb3_block">
						<img src="/static/newmain/images/21.png" /> <a href="<?= Yii::app()
							->createUrl('pages/view/cc'); ?>">Банковская карта</a>
					</div>
					<div class="col-xs-3 mb3_block">
						<img src="/static/newmain/images/17.png" /> <a href="<?= Yii::app()
							->createUrl('pages/view/mkb'); ?>">Терминал МКБ</a>
					</div>
					<div class="col-xs-3 mb3_block">
						<img src="/static/newmain/images/18.png" /> <a href="<?= Yii::app()
							->createUrl('pages/view/qiwi'); ?>">QIWI-кошелек</a>
					</div>
					<div class="col-xs-3 mb3_block">
						<img src="/static/newmain/images/19.png" /> <a href="<?= Yii::app()
			...
			<div class="col-sm-6 col-sm-offset-3 col-xs-8 col-xs-offset-2">
				<div class="row">
					<div class="col-xs-4 mb3_block">
						<img src="/static/newmain/images/22.png" /> <a href="<?= Yii::app()
							->createUrl('pages/view/paymobile'); ?>">Мобильный телефон</a>
					</div>
					<div class="col-xs-4 mb3_block">
						<img src="/static/newmain/images/23.png" /> <a href="<?= Yii::app()
							->createUrl('pages/view/yandexmoney'); ?>">Яндекс-деньги</a>
					</div>
					<div class="col-xs-4 mb3_block">
						<img src="/static/newmain/images/20.png" /> <a href="<?= Yii::app()
