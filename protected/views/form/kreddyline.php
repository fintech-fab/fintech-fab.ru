...
?>
	...
	<article>
		...
		<div class="data-box">
			<div class="container">
				<p>
					Сервис Кредди предоставляет услугу, стоимость которой фиксирована. Процентная ставка не зависит от
					суммы микрозайма и срока использования суммы микрозайма, а устанавливается фиксированным платежом,
					который оплачивается либо перед началом пользования КРЕДДИтной линией, либо после окончания срока
					пользования КРЕДДИтной линией. <br /> При подключении КРЕДДИтной линии 2000р, стоимость подключения
					составляет 900 р /мес.<br /> При подключении КРЕДДИтной линии 7500р, стоимость подключения
					составляет 900 р /мес. </p>

				<p>
					При нарушении Заемщиком сроков возврата Суммы микрозайма Займодавец вправе потребовать:<br /> -
					уплаты Заемщиком пени (неустойки) за каждый день просрочки в размере 2% от суммы микрозайма;<br /> -
					уплаты единовременного штрафа, начисляемого на 7 (седьмой) день просрочки в размере 40% от суммы
					микрозайма;<br /> - обратиться в коллекторское агентство для взыскания задолженности с Заемщика в
					досудебном порядке;<br /> - обратиться в суд за защитой нарушенных прав и своих законных интересов.
				</p>

				<p>
					Заемщик обязан вернуть сумму микрозайма в день окончания срока действия КРЕДДИтной линии.
					Возможности отсрочить срок возврата невозможно. </p>
			</div>
		</div>
		<!--================/data-box================-->
