...
class ClientCreateFormAbstract extends CFormModel
{
	...
	public static function getHints()
	{
		$aHintsFormFields = array(
			...
			'password' => 'Создайте и введите свой пароль. Обращаем внимание, что пароль набирается только в латинской раскладке и должен содержать не менее 8 символов, в том числе не менее одной цифры, одной заглавной и одной строчной буквы.',
