 ...
 *
 */
class ClientSubscribeFlexibleProductForm extends ClientCreateFormAbstract
{
	public $amount;
	public $time;
	public $channel_id;
	...
	public function rules()
	{
		$aRules = array(
			...
			array('channel_id', 'in', 'range' => array_keys(Yii::app()->productsChannels->getChannelsForButtons()), 'message' => 'Выберите правильный способ получения займа')
		);
