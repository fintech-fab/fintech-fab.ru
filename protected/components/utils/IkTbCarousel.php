...
class IkTbCarousel extends TbCarousel
{
	 ...
	 */
	protected function renderIndicators($items)
	{
		echo '<ol class="carousel-indicators">';

		foreach ($items as $i => $item) {
			echo '<li data-target="#' . $this->htmlOptions['id'] . '" data-slide-to="' . $i . '"' . (($i === 0) ? 'class="active"' : '') . '></li>';
		}
		echo '</ol>';
	}
