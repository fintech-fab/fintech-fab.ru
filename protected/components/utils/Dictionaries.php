...
class Dictionaries
{
	...
	const C_ERR_CODE_TRIES = 'Ты превысил число допустимых попыток ввода кода. Обратись в контактный центр.';
	const C_ERR_TRIES_LEFT = 'Осталось попыток: ';

	const C_ERR_CODE_TIME_EXPIRED = 'Истекло время действия кода. Повторите запрос кода';

	const C_ERR_SMS_PASS_TRIES = 'Ты превысил число допустимых попыток ввода пароля. Обратись в контактный центр.';
