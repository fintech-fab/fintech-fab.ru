...
class Dictionaries
{
	const C_ERR_GENERAL = 'Ошибка: обратись в контактный центр.';
	const C_ERR_CODE_SENT = 'Ошибка: код уже отправлен';
	const C_ERR_CODE_CANT_SEND = "Ошибка при отправке кода";
	const C_ERR_CODE_TRIES = 'Число допустимых попыток ввода кода превышено. Обратись в контактный центр.';
	const C_ERR_TRIES_LEFT = 'Осталось попыток: ';

	const C_ERR_CODE_TIME_EXPIRED = 'Истекло время действия кода. Повтори запрос кода';

	const C_ERR_SMS_PASS_TRIES = 'Число допустимых попыток ввода кода превышено. Обратись в контактный центр.';
	...
	const C_SMS_RESET_PASSWORD_SUCCESS = "SMS с паролем отправлено на указанный номер";
	...
	const C_FAQ_SUCCESS = "Спасибо за вопрос! Специалист ответит в ближайшее время.";
	...
	public static $aHintsFormFields = array(
		...
		'birthday'   => 'Пожалуйста, укажи свою дату рождения.',
		'phone'      => 'Для успешной идентификации введи личный номер мобильного телефона.',
		'email'      => 'Введи свой адрес электронной почты.',
		/*''           => 'Пожалуйста, отметьте Ваш пол.',

		''           => 'Пожалуйста, укажи серию и номер Вашего паспорта.',
		''           => 'Пожалуйста, укажи дату выдачи паспорта.',
		''           => 'Пожалуйста, введите код подразделения, выдавшего Ваш паспорт – указан на второй странице паспорта.',
		''           => 'Пожалуйста, укажи государственный орган, выдавший паспорт.',
		...
		''           => 'Пожалуйста, укажи регион постоянной регистрации.',
		...
		''           => 'Пожалуйста, укажи регион Вашего фактического проживания.',
		...
		''           => 'Пожалуйста, укажи название организации, в которой работаете. ',
		''           => 'Пожалуйста, укажи свою должность.',
		''           => 'Введите номер рабочего телефона.',
		''           => 'Введите свой трудовой стаж на текущем месте работы.',


		''           => 'Пожалуйста, укажи Ваш среднемесячный доход.',
		''           => 'Пожалуйста, укажи сумму Ваших среднемесячных расходов.',
...
*/
	...
	public static $aDocumentsPopovers = array(
		0 => 'Пожалуйста, выбери из списка название второго документа',
		1 => 'Введи серию и номер заграничного паспорта (всего 9 цифр). Пример: 123456789',
		2 => 'Введи номер водительского удостоверения, используя только цифры и русские буквы',
		3 => 'Введи номер пенсионного удостоверения',
		4 => 'Введи номер военного билета, используя только цифры и русские буквы. Пример: АБ1234567',
		5 => 'Введи 12 цифр номера ИНН. Пример: 123456789012',
		6 => 'Введи 11 цифр номера страхового свидетельства. Пример: 12345678901',
	);
