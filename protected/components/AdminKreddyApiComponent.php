...
class AdminKreddyApiComponent
{
	...
	const C_CARD_AGREEMENT = "Время зачисления денег зависит от банка-эмитента твоей карты. В некоторых случаях срок зачисления может составлять несколько дней. Обращаем твое внимание, МФО ООО «Арбитр-Факторинг» оставляет за собой право увеличить срок возврата денег, указанный в Приложение №1 к Договору (Оферте), не более, чем на 3 дня.";
