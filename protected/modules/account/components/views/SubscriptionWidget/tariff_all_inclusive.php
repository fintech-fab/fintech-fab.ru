...
<div id="product_type_choose_div">
	...
	<div id="product_type_<?= $oModel::C_PRE_PAID ?>_tip_text" class="alert alert-warning product_type_tooltip">
		Сразу оплачиваешь 750 руб. абонентку за подключение сервиса на месяц. За пользование деньгами - дополнительно 8
		руб. в день.<br /><br /> Максимальная стоимость сервиса в месяц - 990 руб.
	</div>

	<div id="product_type_<?= $oModel::C_POST_PAID ?>_tip_text" class="alert alert-warning product_type_tooltip">
		Подключаешь сервис на месяц, берешь деньги, а 750 р. абонентку платишь при первом возврате денег.<br /><br /> За
		пользование деньгами - дополнительно 15 руб. в день. Максимальная стоимость сервиса в месяц - 1200 руб.
	</div>
</div>
