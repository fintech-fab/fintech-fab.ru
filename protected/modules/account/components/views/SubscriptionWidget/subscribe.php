...
$this->beginWidget('bootstrap.widgets.TbModal', array('id' => 'registry_view')); ?>
	<div class="modal-header">
		...
		<h4>Я ознакомлен со сведениями о внесении ООО «Арбитр-Факторинг» в государственный реестр МФО</h4>
	</div>
	<div class="modal-body">
		<p>Направляя в МФО ООО «Арбитр-Факторинг» данную форму заявления о предоставлении микрозайма, заполненного мною
			дистанционным способом, подтверждаю, что проинформирован о том, что МФО ООО «Арбитр-Факторинг»
			...
			что копию свидетельства о внесении сведений об ООО «Арбитр-Факторинг» в государственный реестр
...
$this->beginWidget('bootstrap.widgets.TbModal', array('id' => 'not_public_view')); ?>
	...
	<div class="modal-body">
		<p>Направляя в МФО ООО «Арбитр-Факторинг» данную форму заявления о предоставлении микрозайма, заполненного
