...
$flagHideFormCheckSMSCode = (empty($smsState['passSent']));
?>
...
<div class="row">
	...
	if (empty($hideSmsSendButton)) {
		$form2 = $this->beginWidget('application.components.utils.IkTbActiveForm', array(
			'id'                     => get_class($codeForm) . '_ajaxsendsms',
			...
			'action'                 => Yii::app()->createUrl('/account/test', array('getcode' => 1)),
		));

		$this->widget('bootstrap.widgets.TbButton', array(
			'id'          => 'sendSms',
			'buttonType'  => 'ajaxSubmit',
			'url'         => Yii::app()->createUrl('/account/test', array('getcode' => 1)),
			'size'        => 'small',
			...
			'ajaxOptions' => array(
				...
				'success'  => "function(data) {
                                	...
                                	if(data.type == 0) { /* SMS успешно отправлено */
                                	    ...
                                	    jQuery('#" . get_class($codeForm) . "_ajaxresendsms').show();
	...
	<?php $form = $this->beginWidget('application.components.utils.IkTbActiveForm', array(
		'id'                     => get_class($codeForm) . "_checksmspass",
		'enableClientValidation' => true,
		'htmlOptions'            => array(
		...
		'action'                 => Yii::app()->createUrl('/account/test', array('act' => $act)),
	));
	?>
	...
	$this->widget('bootstrap.widgets.TbButton', array(
		'buttonType'  => 'ajaxSubmit',
		'type'        => 'primary',
		'url'         => Yii::app()->createUrl('/account/test', array('act' => $act, 'ajax' => 1)),
		'size'        => 'small',
	...
	$form3 = $this->beginWidget('application.components.utils.IkTbActiveForm', array(
		'id'                     => get_class($codeForm) . '_ajaxresendsms',
		'enableClientValidation' => true,
		'clientOptions'          => array(
			'validateOnChange' => true,
			'validateOnSubmit' => true,
		...
		'action'                 => Yii::app()->createUrl('/account/test', array('resend' => 1)),
	));
	$this->widget('bootstrap.widgets.TbButton', array(
		'id'          => 'btnResend',
		'buttonType'  => 'ajaxSubmit',
		'icon'        => 'icon-refresh',
		'url'         => Yii::app()->createUrl('/account/test', array('resend' => 1)),
		'size'        => 'small',
