...
<div class="form" id="activeForm">
	...
	<p class="note">Для получения нового пароля введи номер мобильного телефона и номер паспорта РФ.<br /> На указанный
		номер телефона будет отправлено SMS-сообщение с кодом для подтверждения нового пароля.</p>
